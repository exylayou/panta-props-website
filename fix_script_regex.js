...
// The corrupted code starts right around `function setupGalleryInteractions()`
// and extends through `}, 500); \n          });`

const regex = /function setupGalleryInteractions\(\) {[\s\S]*?\}, 500\);\s*\}\);/g;
...
if (html.match(regex)) {
    html = html.replace(regex, perfectCode);
